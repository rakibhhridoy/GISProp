...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \vspace{0.3cm}
        {\large\color{white!80!PrimaryBlue}
        ...
        \begin{tcolorbox}[enhanced, colback=LightGrey, colframe=MidGrey,
            ...
            \begin{tabular}{@{}ll@{}}
                ...
                \textcolor{HeaderGrey}{\textbf{Contact:}}       & \href{mailto:rakibhhridoy@yahoo.com}{\textcolor{SecondaryBlue}{rakibhhridoy@yahoo.com}} \quad \href{mailto:info@precinctsmart.com}{\textcolor{SecondaryBlue}{info@precinctsmart.com}} \\
        ...
        % KPI row
        {\large\bfseries\textcolor{DarkGrey}{Key Business Parameters}}
        ...
        \begin{tabular}{p{3.8cm} p{0.3cm} p{3.8cm} p{0.3cm} p{3.8cm}}
            ...
            \begin{tcolorbox}[colback=PrimaryBlue!8, colframe=PrimaryBlue,
                ...
                {\large\bfseries\color{PrimaryBlue}BDT 100--125L}\\
            ...
            \begin{tcolorbox}[colback=AccentGreen!8, colframe=AccentGreen,
                arc=5pt, boxrule=0.9pt, halign=center,
                left=4pt, right=4pt, top=6pt, bottom=6pt]
                {\large\bfseries\color{AccentGreen}Month 10}\\
                {\small\color{DarkGrey}Break-even}
            \end{tcolorbox}
            & &
            \centering
            \begin{tcolorbox}[colback=SecondaryBlue!8, colframe=SecondaryBlue,
                arc=5pt, boxrule=0.9pt, halign=center,
                left=4pt, right=4pt, top=6pt, bottom=6pt]
                {\large\bfseries\color{SecondaryBlue}BDT 330.5L}\\
