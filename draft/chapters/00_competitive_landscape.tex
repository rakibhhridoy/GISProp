...
\begin{itemize}
    \item \textcolor{AccentGreen}{✓ Strength:} Long-established reputation, comprehensive service portfolio
    \item \textcolor{AccentGreen}{✓ Strength:} Government and large infrastructure project experience
...
\textbf{Competitive Assessment:}
\begin{itemize}
    \item \textcolor{AccentGreen}{✓ Strength:} Modern, tech-forward positioning
    \item \textcolor{AccentGreen}{✓ Strength:} Diverse service offerings beyond basic surveys
...
\textbf{Competitive Assessment:}
\begin{itemize}
    \item \textcolor{AccentGreen}{✓ Strength:} Construction/development sector expertise
    \item \textcolor{AccentGreen}{✓ Strength:} Quick turnaround on project delivery
...
\textbf{Competitive Assessment:}
\begin{itemize}
    \item \textcolor{AccentGreen}{✓ Strength:} Long-standing reputation since 1990
    \item \textcolor{AccentGreen}{✓ Strength:} Diversified services (geotechnical + surveying)
...
\textbf{Competitive Assessment:}
\begin{itemize}
    \item \textcolor{AccentGreen}{✓ Strength:} Direct farmer engagement and training
    \item \textcolor{AccentGreen}{✓ Strength:} Focus on agricultural application (matching our target)
    \item \textcolor{AccentGreen}{✓ Strength:} Low-cost approach enabling widespread adoption
...
\textbf{Competitive Assessment:}
\begin{itemize}
    \item \textcolor{AccentGreen}{✓ Strength:} LiDAR technology emphasis (like our approach)
