...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{l | X | X | X | X}
        ...
        \hline
        \cellcolor{LightGrey}\textbf{PRECINCT SMART} & \cellcolor{LightGrey}\textbf{LiDAR + ML} & \cellcolor{LightGrey}\textbf{Multi-sector} & \cellcolor{LightGrey}\textbf{Yes} & \cellcolor{LightGrey}\textbf{Yes} \\
        \hline
    \end{tabularx}
\end{table}
