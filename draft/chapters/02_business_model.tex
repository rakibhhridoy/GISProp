...
The business is structured around four service tiers. Each one targets a different type of client relationship, margin profile, and level of engagement:
...
Revenue is spread across four streams rather than concentrated in project work alone --- which creates real resilience:
...
Building revenue across four streams creates some useful structural properties:
\begin{itemize}
...
Rather than pricing to costs or matching competitors, Precinct Smart prices to the value delivered. A government agency replacing 25-year-old survey data has a very different willingness to pay than a smallholder farmer. The fee structure reflects that:
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l | X | X | l}
        ...
        \hline
        \textbf{\textcolor{PrimaryBlue}{Small Farmer}} & 50 ha survey & Cost recovery + 100\% & \textbf{\textcolor{AccentGreen}{BDT 1.5L}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Large Agri-Co}} & 1,000 ha + advisory & Cost + 150\% + yield gains & \textbf{\textcolor{AccentGreen}{BDT 4--6L}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Government}} & 10,000 ha region & Cost + 50\% (volume) & \textbf{\textcolor{AccentGreen}{BDT 40--60L}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Real Estate}} & 500 ha + 3D model & Cost + 200\% + IP value & \textbf{\textcolor{AccentGreen}{BDT 10--15L}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{NGO Partnership}} & Farmer mapping + capacity & Cost + 50--75\% social impact & \textbf{\textcolor{AccentGreen}{BDT 1.5--2.5L}} \\
        \hline
    \end{tabularx}
\end{table}
...
The combination of recurring subscriptions, high-margin consulting, and a growing app platform creates real resilience. By Year 3, the model delivers:
