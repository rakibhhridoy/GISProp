...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X | l | l | l}
        ...
        \hline
        \textbf{\textcolor{PrimaryBlue}{Revenue (BDT Lakhs)}} & 30 & \textbf{\textcolor{SecondaryBlue}{96.5}} & \textbf{\textcolor{AccentGreen}{204}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Operating Costs}} & 28 & \textbf{\textcolor{SecondaryBlue}{47}} & \textbf{\textcolor{AccentGreen}{68}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Net Profit}} & 2 & \textbf{\textcolor{SecondaryBlue}{49.5}} & \textbf{\textcolor{AccentGreen}{136}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Profit Margin}} & 7\% & \textbf{\textcolor{SecondaryBlue}{51\%}} & \textbf{\textcolor{AccentGreen}{67\%}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Break-even Month}} & 10 & \textbf{\textcolor{SecondaryBlue}{2 (at start)}} & \textbf{\textcolor{AccentGreen}{--}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{ROI}} & 1.5\% & \textbf{\textcolor{SecondaryBlue}{49\%}} & \textbf{\textcolor{AccentGreen}{104\%}} \\
        \hline
        \textbf{\textcolor{PrimaryBlue}{Payback Period}} & 45 mo. & \textbf{\textcolor{SecondaryBlue}{24 mo.}} & \textbf{\textcolor{AccentGreen}{11 mo.}} \\
        \hline
        \cellcolor{AccentGreen!15}\textbf{Cumulative Profit} & \cellcolor{AccentGreen!15}BDT 2L & \cellcolor{AccentGreen!15}\textbf{\textcolor{SecondaryBlue}{BDT 51.5L}} & \cellcolor{AccentGreen!15}\textbf{\textcolor{AccentGreen}{BDT 187.5L}} \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X | l | l}
        ...
        \hline
        \cellcolor{LightGrey}\textbf{Total Delivery Cost} & \cellcolor{LightGrey} & \cellcolor{LightGrey}\textbf{\textcolor{PrimaryBlue}{BDT 1,30,000}} \\
        \hline
        \cellcolor{AccentGreen!15}\textbf{Selling Price (value-based)} & \cellcolor{AccentGreen!15} & \cellcolor{AccentGreen!15}\textbf{\textcolor{AccentGreen}{BDT 3,50,000 -- 5,00,000}} \\
        \hline
        \cellcolor{AccentGreen!25}\textbf{Gross Margin} & \cellcolor{AccentGreen!25} & \cellcolor{AccentGreen!25}\textbf{\textcolor{AccentGreen}{62--74\%}} \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X | l | l}
        ...
        \hline
        \cellcolor{AccentGreen!15}\textbf{Total Delivery Cost} & \cellcolor{AccentGreen!15} & \cellcolor{AccentGreen!15}\textbf{\textcolor{AccentGreen}{BDT 2,12,500}} \\
        \hline
        \cellcolor{AccentGreen!25}\textbf{Selling Price (value-based)} & \cellcolor{AccentGreen!25} & \cellcolor{AccentGreen!25}\textbf{\textcolor{AccentGreen}{BDT 4,00,000 -- 6,00,000}} \\
        \hline
        \cellcolor{AccentGreen!35}\textbf{Gross Margin} & \cellcolor{AccentGreen!35} & \cellcolor{AccentGreen!35}\textbf{\textcolor{AccentGreen}{50--65\%}} \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X | l | l}
        ...
        \hline
        \cellcolor{LightGrey}\textbf{Total Delivery Cost} & \cellcolor{LightGrey} & \cellcolor{LightGrey}\textbf{\textcolor{PrimaryBlue}{BDT 1,60,000}} \\
        \hline
        \cellcolor{AccentGreen!15}\textbf{Selling Price (value-based)} & \cellcolor{AccentGreen!15} & \cellcolor{AccentGreen!15}\textbf{\textcolor{AccentGreen}{BDT 8,00,000 -- 15,00,000}} \\
        \hline
        \cellcolor{AccentGreen!20}\textbf{Gross Margin} & \cellcolor{AccentGreen!20} & \cellcolor{AccentGreen!20}\textbf{\textcolor{AccentGreen}{70--80\%}} \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X | X | X}
        ...
        \hline
        50\% lower revenue than projected & \textcolor{AccentOrange}{Loss of BDT 15L Y1} & \textcolor{AccentGreen}{Reduce costs; seek investor support} \\
        \hline
        Equipment malfunction & \textcolor{AccentOrange}{3-month downtime} & \textcolor{AccentGreen}{Backup drone; maintenance fund} \\
        \hline
        Pilot certification delay & \textcolor{AccentOrange}{Unable to fly 2--3 months} & \textcolor{AccentGreen}{Start process immediately} \\
        \hline
        Monsoon (40\% non-flyable) & \textcolor{AccentOrange}{Revenue loss Jun--Sep} & \textcolor{AccentGreen}{Multi-region operations} \\
        \hline
    \end{tabularx}
\end{table}
