...
\begin{importantbox}
    ...
    \begin{itemize}
        ...
        \item \textbf{Your Startup Addressable Market:} USD 500K - 1.5M (Years 1-3)
    \end{itemize}
\end{importantbox}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{l | X | X | X | X}
        ...
        \hline
        \cellcolor{LightGrey}\textbf{Your Startup} & \cellcolor{LightGrey}\textbf{LiDAR + ML} & \cellcolor{LightGrey}\textbf{Value-based} & \cellcolor{LightGrey}\textbf{Multi-sector} & \cellcolor{LightGrey}\textbf{Tech + Impact} \\
        \hline
    \end{tabularx}
\end{table}
...
\textcolor{SecondaryBlue}{\textbf{Key Takeaway:}} Your competitive advantage lies in advanced technology (LiDAR + ML) combined with a multi-sector approach and strong NGO partnerships—capabilities that existing competitors have not yet integrated effectively.
